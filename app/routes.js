...
module.exports = function (app) {
  ...
  app.use('/shortMessage', shortMessageRoutes);
  shortMessageRoutes.get('/sendShortMessageForLogin', shortMessage.sendShortMessageForLogin);
  shortMessageRoutes.get('/sendShortMessageForReset', shortMessage.sendShortMessageForReset);
  shortMessageRoutes.get('/checkShortMessage', shortMessage.checkShortMessage);
